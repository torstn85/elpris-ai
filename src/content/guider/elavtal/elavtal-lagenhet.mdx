...
metaTitle: "Elavtal lägenhet 2026 – guide för lägenhetsboende"
...
keywords:
  ...
  - elpris lägenhet
faqs:
  - question: "Vilket elavtal är bäst för lägenhet?"
    answer: "För de flesta lägenhetsboende är rörligt månadspris med lågt påslag det bästa valet. Förbrukningen är så låg (1 500-4 000 kWh/år för de flesta) att en eventuell prisrisk är hanterbar, och du slipper tänka på att flytta tvätt eller diskmaskin till specifika timmar. Kvartspris ger marginell extra besparing om du inte har elbil eller värmepump — kanske 200-500 kr/år. Det viktigaste är att undvika tillsvidareavtal, som är 30-50% dyrare än marknadens bästa."
  - question: "Hur mycket el drar en lägenhet per år?"
    answer: "En liten lägenhet (1-2 rok) med ensamboende drar typiskt 1 500-2 500 kWh/år, medan en större lägenhet (3-4 rok) med familj drar 2 500-4 000 kWh/år. Lägenheter med el-uppvärmning drar betydligt mer — 5 000-8 000 kWh/år — men det är sällsynt. Den största delen går till hushållsel: kylskåp, frys, belysning, matlagning, TV och datorer. För familjer kan tvätt och torktumlare också vara en betydande del."
  - question: "Behöver jag eget elavtal om jag bor i hyresrätt?"
    answer: "Det beror på hyresvärden. I de flesta hyresrätter ingår el i hyran (kallas hyresvärdsel eller kollektivt mätt el), och då tecknar du inget eget avtal — hyresvärden köper elen och fördelar kostnaden över alla hyresgäster. I en mindre andel hyresrätter har du dock eget elabonnemang med separat mätare. Då kan och ska du teckna eget elavtal. Bor du i bostadsrätt har du nästan alltid eget elabonnemang."
  - question: "Hur mycket kan jag spara på att byta elavtal i lägenhet?"
    answer: "För ett vanligt lägenhetshushåll som drar 3 000 kWh/år är skillnaden mellan ett dåligt tillsvidareavtal och ett lågprisalternativ cirka 768 kr/år — bara genom att välja rätt elhandelsbolag, utan att ändra något annat. För en familj med 4 000 kWh blir skillnaden över 1 000 kr/år. Räkningen domineras av påslag (5-10 öre vs 1 öre) och månadsavgift (40-60 kr vs 0 kr). Tillsvidareavtal är den vanligaste fällan och kostar typiskt 700-1 000 kr extra per år."
  - question: "Vad händer med mitt elavtal när jag flyttar?"
    answer: "Du säger upp ditt elavtal när du flyttar ut, oftast med 1-3 månaders uppsägningstid beroende på avtalstyp. Den nya hyresgästen eller ägaren tecknar sitt eget avtal. Mellanperioden — från det att du flyttar ut tills nästa person tecknar — täcks av nätbolaget med ett anvisat avtal. När du flyttar in i den nya bostaden hamnar du automatiskt på ett anvisat avtal tills du själv aktivt väljer leverantör, så det är klokt att teckna nytt avtal redan första veckan."
  - question: "Behöver jag kvartspris om jag bara har vanlig hushållsel?"
    answer: "Inte nödvändigtvis. För en lägenhet utan elbil eller värmepump är besparingen från kvartspris marginell — typiskt 200-500 kr/år. Det blir bara värt besväret om du har egen tvättmaskin med fördröjd start, möjlighet att tvätta nattetid, och disciplin att laga mat utanför kvällstoppen 17-20. För de flesta lägenhetsboende är rörligt månadspris med lågt påslag enklare och nästan lika billigt — välj kvartspris främst om du faktiskt kommer använda flexibiliteten."
readTime: "7 min"
---
...
I en mindre andel hyresrätter har du dock **eget elabonnemang** med separat mätare. Då kan och ska du teckna eget elavtal.
...
Förbrukningen i en lägenhet är generellt mycket lägre än i en villa, eftersom uppvärmning oftast är inkluderad i hyran/avgiften. Bor du i hus med eget värmesystem är förutsättningarna helt annorlunda — då passar vår [elavtalsguide för villaägare](/guider/elavtal/elavtal-villa) bättre. Typiska siffror för 2026:
