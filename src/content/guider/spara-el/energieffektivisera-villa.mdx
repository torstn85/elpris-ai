...
**Snabba svaret:** De fem åtgärderna med kortast återbetalningstid för en typisk villaägare är (1) tätning av otätheter och dörrar, (2) tilläggsisolering av vinden, (3) byte till luft/vatten-värmepump om du har äldre uppvärmning, (4) smart styrning kopplad till spotpriset, och (5) byte till energieffektiva 3-glasfönster. Solceller och hembatteri är två andra kraftfulla åtgärder som kan sänka elräkningen rejält — de räknas dock som energiproduktion snarare än effektivisering, och vi går igenom dem djupare i [vår guide om solceller och spotpris](/guider/spara-el/solceller-spotpris) respektive [hembatteri-guiden](/guider/teknik-och-trender/hembatteri-solceller). För en villa byggd före 1980 kan de tre första åtgärderna tillsammans halvera elräkningen och betala sig på 5–10 år.
