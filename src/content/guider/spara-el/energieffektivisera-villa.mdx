...
faqs:
  ...
  - question: "Kan jag kombinera ROT-avdrag och Grön teknik?"
    answer: "Ja, du kan kombinera ROT-avdrag och Grön teknik-avdrag — men inte på samma åtgärd. Du kan till exempel använda ROT-avdrag för värmepumpsinstallation och samtidigt Grön teknik-avdrag för en solanläggning. Däremot kan du inte få båda avdragen för exempelvis solcellsinstallationen. De två avdragen delar ett gemensamt maxbelopp på 50 000 kr per person och år — så det är värt att planera fördelningen om du gör flera större installationer samma år. ROT gäller bara arbetskostnaden (30 %), medan Grön teknik gäller både arbete och material (15 % för solceller, 50 % för hembatteri och laddningspunkter). Använd Skatteverkets tjänst 'Räkna ut skatt' för att se din preliminära skattereduktion innan du beställer."
...
Maxbeloppet är 50 000 kr per person och år, gemensamt med eventuella andra skattereduktioner. För en solanläggning på 150 tkr (arbete + material) blir avdraget 22 500 kr. För ett hembatteri på 80 tkr blir avdraget 40 000 kr. Avdraget dras direkt på fakturan av installatören — du betalar mellanskillnaden och företaget begär utbetalning från Skatteverket.
